    ...
    >
      <div className="space-y-4 py-6 text-center">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm font-medium text-violet-300 flex items-center justify-center gap-1.5">
            <span className="line-through text-zinc-500 font-normal">$11.99</span>
            <span className="text-emerald-400 font-bold">$5.99</span> per slab · Quantity 1
          </p>
        </div>
